...
public class ice_sem5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ice_sem5);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ice_sem5.this, EieSemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(ice_sem5.this, "GPA Copied", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void write() {
        ...
        try {
            ...
            Toast.makeText(ice_sem5.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
