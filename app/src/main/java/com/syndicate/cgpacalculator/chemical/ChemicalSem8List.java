...
public class ChemicalSem8List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chemical_sem8_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ChemicalSem8List.this, ChemicalSemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(ChemicalSem8List.this, "GPA Copied", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public float calculate() {
        ...
        float res = ((float) val1 * 4 + (float) val2 * 3 + (float) val3 * 3 + (float) val4 * 3 + (float) val5 * 3 + (float) val6 * 2 + (float) val7 * 6 + (float) val8 * 2 + (float) val9 * 1) / 27;
    ...
    public void write() {
        ...
        try {
            ...
            Toast.makeText(ChemicalSem8List.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
