...
public class ChemicalSem5List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chemical_sem5_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ChemicalSem5List.this, ChemicalSemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(ChemicalSem5List.this, "GPA Copied", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public float calculate() {
        ...
        float res = ((float) val1 * 3 + (float) val2 * 4 + (float) val3 * 4 + (float) val4 * 3 + (float) val5 * 3 + (float) val6 * 3 + (float) val7 * 2 + (float) val8 * 2 + (float) val9 * 2 + (float) val10 * 2) / 28;
    ...
    public void write() {
        ...
        try {
            ...
            Toast.makeText(ChemicalSem5List.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
