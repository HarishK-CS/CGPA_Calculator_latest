...
public class ChemicalSem3List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chemical_sem3_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ChemicalSem3List.this, ChemicalSemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(ChemicalSem3List.this, "GPA Copied", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public float calculate() {
        ...
        float res = ((float) val1 * 4 + (float) val2 * 3 + (float) val3 * 3 + (float) val4 * 3 + (float) val5 * 4 + (float) val6 * 4 + (float) val7 * 2 + (float) val8 * 2 + (float) val9 * 2 ) / 27;
    ...
    public void write() {
        ...
        try {
            ...
            Toast.makeText(ChemicalSem3List.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
