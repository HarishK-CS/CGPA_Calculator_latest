...
public class mtr_sem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mtr_sem);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(mtr_sem.this, MainActivity.class);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if(i==0) {
                    Intent intent = new Intent(mtr_sem.this, CseSem1List.class);
                    startActivity(intent);
                }else if(i==1) {
                    Intent intent = new Intent(mtr_sem.this, CseSem2List.class);
                    startActivity(intent);
                }else if(i==2) {
                    Intent intent = new Intent(mtr_sem.this, mtr_sem3.class);
                    startActivity(intent);
                }else if(i==3) {
                    Intent intent = new Intent(mtr_sem.this, mtr_sem4.class);
                    startActivity(intent);
                }else if(i==4) {
                    Intent intent = new Intent(mtr_sem.this, mtr_sem5.class);
                    startActivity(intent);
                }else if(i==5) {
                    Intent intent = new Intent(mtr_sem.this, mtr_sem6.class);
                    startActivity(intent);
                }else if(i==6) {
                    Intent intent = new Intent(mtr_sem.this, mtr_sem7.class);
                    startActivity(intent);
                }else if(i==7) {
                    Intent intent = new Intent(mtr_sem.this, mtr_sem8.class);
                    startActivity(intent);
                }
            }
        });
