...
public class mtr_sem7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mtr_sem7);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(mtr_sem7.this, "GPA Copied", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public float calculate() {
        ...
        float res = ((float) val1 * 4 + (float) val2 * 4 + (float) val3 * 3 + (float) val4 * 3 + (float) val5 * 2 + (float) val6 * 2 + (float) val7 * 4 + (float) val8 * 1 + (float) val9 * 1) / 24;
    ...
    public void write() {
        ...
        try {
            ...
            Toast.makeText(mtr_sem7.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
