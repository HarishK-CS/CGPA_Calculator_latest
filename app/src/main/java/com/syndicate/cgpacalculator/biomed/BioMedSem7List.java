...
public class BioMedSem7List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bio_med_sem7_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BioMedSem7List.this, BioMedSemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(BioMedSem7List.this, "GPA Copied", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public float calculate() {
        ...
        float res = ((float) val1 * 4 + (float) val2 * 3 + (float) val3 * 3 + (float) val4 * 3 + (float) val5 * 3 + (float) val6 * 2 + (float) val7 * 1 + (float) val8 * 1 + (float) val9 * 2 ) / 22;
    ...
    public void write() {
        ...
        try {
            ...
            Toast.makeText(BioMedSem7List.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
