...
public class BioMedSem8List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bio_med_sem8_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BioMedSem8List.this, BioMedSemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(BioMedSem8List.this, "GPA Copied", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public float calculate() {
        ...
        float res = ((float) val1 * 3 + (float) val2 * 3 + (float) val3 * 4 + (float) val4 * 3 + (float) val5 * 3 + (float) val6 * 2 + (float) val7 * 1 + (float) val8 * 2 + (float) val9 * 6 ) / 27;
    ...
    public void write() {
        ...
        try {
            ...
            Toast.makeText(BioMedSem8List.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
