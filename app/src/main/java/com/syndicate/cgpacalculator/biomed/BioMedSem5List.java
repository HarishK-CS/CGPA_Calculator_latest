...
public class BioMedSem5List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bio_med_sem5_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BioMedSem5List.this, BioMedSemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(BioMedSem5List.this, "GPA Copied", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public float calculate() {
        ...
        float res = ((float) val1 * 4 + (float) val2 * 4 + (float) val3 * 3 + (float) val4 * 4 + (float) val5 * 4 + (float) val6 * 4 + (float) val7 * 2 + (float) val8 * 2 + (float) val9 * 2 + (float) val10 * 2) / 31;
    ...
    public void write() {
        ...
        try {
            ...
            Toast.makeText(BioMedSem5List.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
