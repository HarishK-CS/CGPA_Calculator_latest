package com.syndicate.cgpacalculator.eie;
...
public class EieSem6List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eie_sem6_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(EieSem6List.this, EieSemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(EieSem6List.this, "GPA Copied", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public float calculate() {
        ...
        float res = ((float) val1 * 4 + (float) val2 * 4 + (float) val3 * 3 + (float) val4 * 3 + (float) val5 * 4 + (float) val6 * 3 + (float) val7 * 2 + (float) val8 * 2 + (float) val9 * 2 + (float) val10 * 2) / 29;
    ...
    public void write() {
        ...
        try {
            ...
            Toast.makeText(EieSem6List.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
