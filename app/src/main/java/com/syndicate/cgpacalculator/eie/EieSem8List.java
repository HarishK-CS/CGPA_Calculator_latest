...
public class EieSem8List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eie_sem8_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(EieSem8List.this, EieSemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(EieSem8List.this, "GPA Copied", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public float calculate() {
        ...
        float res = ((float) val1 * 3 + (float) val2 * 4 + (float) val3 * 3 + (float) val4 * 3 + (float) val5 * 3 + (float) val6 * 2 + (float) val7 * 1 + (float) val8 * 2 + (float) val9 * 6 ) / 27;
    ...
    public void write() {
        ...
        try {
            ...
            Toast.makeText(EieSem8List.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
