...
public class EieSem7List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eie_sem7_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(EieSem7List.this, EieSemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(EieSem7List.this, "GPA Copied", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public float calculate() {
        ...
        float res = ((float) val1 * 4 + (float) val2 * 4 + (float) val3 * 3 + (float) val4 * 3 + (float) val5 * 3 + (float) val6 * 2 + (float) val7 * 1 + (float) val8 * 1 + (float) val9 * 2 ) / 23;
    ...
    public void write() {
        ...
        try {
            ...
            Toast.makeText(EieSem7List.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
