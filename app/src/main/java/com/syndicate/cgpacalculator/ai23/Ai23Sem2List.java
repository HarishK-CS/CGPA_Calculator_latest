...
public class Ai23Sem2List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ai23_sem2_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Ai23Sem2List.this, Ai23SemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Ai23Sem2List.this, "GPA Copied", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public float calculate() {
        ...
        float res = ((float) val1 * 3 + (float) val2 * 4 + (float) val3 * 3 + (float) val4 * 3 + (float) val5 * (float) 2.5 + (float) val6 * 2 + (float) val7 * 3 ) / (float) 20.5;
    ...
    public void write() {
        ...
        try {
            ...
            Toast.makeText(Ai23Sem2List.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
