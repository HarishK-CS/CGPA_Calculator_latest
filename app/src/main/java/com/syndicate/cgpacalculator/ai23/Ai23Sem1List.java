...
public class Ai23Sem1List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ai23_sem1_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Ai23Sem1List.this, Ai23SemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Ai23Sem1List.this, "GPA Copied", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void write() {
        ...
        try {
            ...
            Toast.makeText(Ai23Sem1List.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
