...
public class Ai23Sem4List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ai23_sem4_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Ai23Sem4List.this, Ai23SemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Ai23Sem4List.this, "GPA Copied", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public float calculate() {
        ...
        float res = ((float) val1 * 4 + (float) val2 * 4 + (float) val3 * 3 + (float) val4 * 3 + (float) val5 * 3 + (float) val6 * (float) 1.5 + (float) val7 * (float) 1.5 + (float) val8 * (float) 1.5 ) / (float) 22.5;
    ...
    public void write() {
        ...
        try {
            ...
            Toast.makeText(Ai23Sem4List.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
