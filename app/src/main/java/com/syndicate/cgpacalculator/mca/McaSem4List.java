...
public class McaSem4List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mca_sem4_list);
...
//        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(McaSem4List.this, McaSem2List.class);
...
//                t7.setText("");
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(McaSem4List.this,"GPA Copied",Toast.LENGTH_SHORT).show();
            }
        });
...
//        }
        ...
        float res = ((float)val1*4+(float)val2*4+(float)val3*4)/30;
        ...
        try{
            ...
            Toast.makeText(McaSem4List.this,"Added To CGPA ",Toast.LENGTH_SHORT).show();
