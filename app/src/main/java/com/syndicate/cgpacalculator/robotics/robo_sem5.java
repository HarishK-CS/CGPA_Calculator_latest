...
public class robo_sem5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.robo_sem5);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(robo_sem5.this, AiSemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(robo_sem5.this, "GPA Copied", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public float calculate() {
        ...
        float res = ((float) val1 * 4 + (float) val2 * 4 + (float) val3 * 4 + (float) val4 * 4 + (float) val5 * 4 + (float) val6 * 4 + (float) val7 * 2 + (float) val8 * 2 + (float) val9 * 2 + (float) val10 * 1) /  30;
    ...
    public void write() {
        ...
        try {
            ...
            Toast.makeText(robo_sem5.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
